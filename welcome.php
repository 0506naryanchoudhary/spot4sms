  ...
  <div class="container-fluid" id = "navi">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
      	<li class="active"><a href=http://kold.co.nf/message/send.php>Send</a></li>
      	<li><a href=send.php>Sent</a></li>
      	<li><a href=http://kold.co.nf/message/contact.php>Contacts</a></li>
	    ...
	    <div class="col-xs-10 col-xs-offset-1 col-sm-6 col-sm-offset-3 col-md-4 col-md-offset-4   ">
		    <div class="panel panel-default w3-card-4">
				...
				<div class="panel-body">
					<form role="form" id = "myForm" method = "post" action = "http://kold.co.nf/message/send0.php">
